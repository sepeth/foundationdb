...
configure log_spill:=2` to enable spill-by-reference.  Only FDB 6.1 or older
...
: The version of the last commit that is being spilled to disk.

`PersistentDataDurableVersion`
: The version of the last commit that has been durably written to disk.
